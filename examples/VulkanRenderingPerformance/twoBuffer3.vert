...
void main() {
	...
	gl_Position.x = coordinateBuffer[index + 0] + data1[index + 0] + 2.;
	gl_Position.y = coordinateBuffer[index + 1] + data1[index + 1] + 2.;
	gl_Position.z = coordinateBuffer[index + 2] + data1[index + 2] + 2.;
	gl_Position.w = 1.;
}
