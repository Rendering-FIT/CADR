// SPDX-FileCopyrightText: 2018-2020 PCJohn (Jan Pečiva, peciva@fit.vut.cz)
//
...
void VulkanWindow::showEvent(QShowEvent* e)
{
	...
	for(vk::PhysicalDevice pd:deviceList) {
		...
		vk::createResultValue(
			pd.getSurfaceFormatsKHR(_surface.get(),&formatCount,nullptr,vk::DispatchLoaderStatic()),
			VULKAN_HPP_NAMESPACE_STRING"::PhysicalDevice::getSurfaceFormatsKHR");
		uint32_t presentationModeCount;
		vk::createResultValue(
			pd.getSurfacePresentModesKHR(_surface.get(),&presentationModeCount,nullptr,vk::DispatchLoaderStatic()),
